  ...
  return true ;
	...
	<body>
		...
		<div id='container'>
			...
			<form action="Test" method="post" onsubmit="return checkinput(this);">

				<img id='logo_img' src="images/logo.png" alt="Logo">
				<h2>Multi-term Keyword Search</h2>
				<h3>in Distributed NoSQL Systems</h3>
				<input id='txtbox' name='query' type='text' placeholder='Enter Search Term Here...'></input>
